// questions_a.js
// CareerDNA v2 — Survey Form A (interleaved question ordering).
// 100 items across 25 subdimensions, interleaved so no subdimension appears consecutively.
// Scores are order-independent. Same question bank as questions.js.
...
const questions = [
  ...
  },
  {
    ...
    subdimension: "Technical Curiosity",
    type: "likert",
    text: "Building, fixing, making, or operating things is where I tend to do my best work.",
  ...
  },
  {
    ...
    subdimension: "Purpose & Impact",
    type: "likert",
    text: "I could feel genuinely satisfied doing work that is interesting and rewarding, even if it makes no real difference beyond my own life.",
