...
const scienceCards = [
  ...
  },
  {
    ...
    body: 'At the heart of CareerDNA is a proprietary intelligence engine that transforms behavioural data into personalised recommendations. By combining psychological patterns, career identity signals and pathway intelligence, it identifies the environments, subjects and opportunities where you are most likely to thrive, then checks them against real outcomes: how courses rank, what graduates earn and what\'s open now.',
    detailTitle: 'Matches against',
    detailType: 'stats',
    details: [
      { icon: Search, value: '25', label: 'Career Worlds' },
      { icon: Compass, value: '220', label: 'Career Pathways' },
      { icon: MessageSquare, value: '440', label: 'Career Roles' },
      { icon: CheckCircle2, value: '750', label: 'Training Routes' },
    ],
  },
  {
    ...
    body: 'Behind the scenes, CareerDNA uses a bespoke AI intelligence engine designed specifically for career discovery. By combining your results, profile patterns and recommendation matches, it creates personalised explanations, answers your questions and helps you decide what to do next.',
    detailTitle: 'Helps you',
    detailType: 'chips',
    details: [
      { icon: Search, label: 'Decode your profile' },
      { icon: Compass, label: 'Explore opportunities' },
      { icon: MessageSquare, label: 'Compare your options' },
